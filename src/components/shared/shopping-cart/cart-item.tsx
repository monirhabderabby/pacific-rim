...
import { StarRating } from "@/components/shared/shopping-cart/star-rating"
        ...
        <div className="flex-1 space-y-1">
              ...
              {item.isHot && (
                <div className="flex items-center gap-3 text-sm">
                  <span className="text-red-500 flex items-center gap-1">
                    <Image className='w-3 h-3' src="/assets/img/Vector.png" alt="hot" width={16} height={16} /> Hot</span>
                  <span className="text-gray-400">{item.views} Views</span>
                </div>
              )}
            </div>
            <div className="flex items-center  bg-green-800/20 px-2 py-1 rounded">
          ...
          <div className="flex items-end justify-between mt-4">
            <div className="space-y-1 flex items-center gap-2">
              ...
              <div className="text-sm text-gray-400 line-through">₭{item.originalPrice.toLocaleString()}</div>
            </div>
          </div>
          <div className="flex items-center justify-between gap-4">
              {/* quantity buttons */}
              <div className="flex items-center gap-3  rounded-2xl shadow-md">
                <button
