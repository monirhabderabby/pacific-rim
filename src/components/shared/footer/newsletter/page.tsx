...
function Page() {
    ...
    return (
        <>
            <section className="relative overflow-hidden object-cover"
                style={{ backgroundImage: "url('assets/newsletter/newsletter-bg.png')", backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}
            >
                        ...
                        <div className="space-y-6 md:pl-8 bg-white p-24 rounded-lg opacity-80">
                            <div className="space-y-4">
                                ...
                                <p className="text-muted-foreground">
                                    Subscribe to our newsletter and be the first to discover the latest CBD tips,
                                    exclusive discounts, and wellness news.
                                </p>
                            </div>
