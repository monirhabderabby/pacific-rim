        ...
        <footer className="bg-zinc-950 text-white py-12">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/terms" className="text-zinc-400 hover:text-white transition-colors">Terms and conditions</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/live-auction" className="text-zinc-400 hover:text-white transition-colors">Live Auction</Link></li>
                            <li><Link href="/features" className="text-zinc-400 hover:text-white transition-colors">Features</Link></li>
                            <li><Link href="/ending-soon" className="text-zinc-400 hover:text-white transition-colors">Ending Soon</Link></li>
                            <li><Link href="/features-auction" className="text-zinc-400 hover:text-white transition-colors">Features Auction</Link></li>
                        </ul>
                    </div>
                ...
                <div className="mt-12 pt-4 border-t border-zinc-800 text-center text-zinc-500 text-sm">
                    <p>2024 WWW Staging - Thailand - Pacific Rim Fusion, LLC. Powered by WWW Staging - Thailand - Pacific Rim Fusion, LLC</p>
                </div>
            </div>
        </footer>
    )
