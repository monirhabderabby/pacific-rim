    ...
    <div className='my-20 py-20 rounded-[52px] bg-primary-light'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 ">
        {categories.map((category) => (
          ...
          >
                <div className="bg-[#1B4D2B] p-4 text-center rounded-lg">
      ...
      <div className="relative z-10 flex h-full flex-col justify-center space-y-6 p-8 text-white">
        ...
        <p className="max-w-2xl text-lg">
          Our platform ensures that all participants have valid Cannabis Business licenses and that
          those licenses are in good standing with the respective agencies or authorities. In this
          way, transactions comply with local and international laws, giving local businesses a
          secure and reliable environment to operate within.
        </p>
    
        <button
          className="w-fit p-3 rounded-lg bg-green-700 hover:bg-green-800"
        >
