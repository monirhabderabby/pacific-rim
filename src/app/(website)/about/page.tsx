    ...
    <section>
      ...
      <div className="container section">
        ...
        <div className="mt-5">
          ...
          <p className="text-base text-[#444444] font-normal leading-[19.2px] mt-3">
            Pacific Rim Fusion is dedicated to fostering a marketplace that
            supports fair competition and the growth of local businesses. We
            adhere to the highest standards of integrity, transparency, and
            compliance, ensuring a safe and effective environment for all users.
          </p>
        </div>
        <div className="mt-5">
          <Heading heading="Join Us" />
          <p className="text-base text-[#444444] font-normal leading-[19.2px] mt-3">
            Join Pacific Rim Fusion today to tap into a network that supports
            local empowerment and market growth. Whether you are looking to sell
            surplus inventory or expand your buying options, our platform is
            designed to help your business thrive amidst global competition.
          </p>
          <p className="text-base text-[#444444] font-normal leading-[19.2px] mt-3">
            Contact us to learn more or sign up for an account and start
            leveraging our platform to boost your business’s potential. For
            inquiries, partnerships, or additional information about how Pacific
            Rim Fusion can help your local business, please visit our Contact
            Page or reach out through our support channel.
          </p>
          <p className="text-base text-[#444444] font-normal leading-[19.2px] mt-3">
