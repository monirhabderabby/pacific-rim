import ListItem from "@/app/(website)/about/_components/list_item";
import StoreHeading from "../about/_components/storeHeading";
import StoreText from "../about/_components/storeText";
import SubHeading from "../about/_components/subheading";

const Page = () => {
  return (
    <div className="w-[870px] border-[1px] border-[#C5C5C5] rounded-[12px]">
      <div className="py-5 pl-5 border-b-[1px] border-[#C5C5C5] ">
        <StoreHeading heading="Policies" />
      </div>
